...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ranguangtai', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '中国科学院大学成都山地灾害与环境研究所', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '数字山地, 遥感', // 网站关键词 英文逗号隔开

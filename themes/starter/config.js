...
const CONFIG = {
  ...
  STARTER_LOGO: 'public/images/starter/cdsds.png', // 普通logo图片 示例：/images/starter/logo/logo.svg
  STARTER_LOGO_WHITE: 'public/images/starter/cdsds.png', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg
  ...
  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: 'public/images/starter/cdsds.png', // 产品预览图 ，默认读取public目录下图片
